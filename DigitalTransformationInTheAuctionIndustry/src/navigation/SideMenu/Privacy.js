...
import { helperStyle } from '../../components/Helper/HelperSreenStyle';

export default class HelperScreen extends Component {
  render() {
    return (
      <View style={style.container}>
        <Header title="Chính sách bảo mật " />
        <ScrollView style={helperStyle.scrollView}>
          <Text style={helperStyle.content}>{helperContent}</Text>
        </ScrollView>
      </View>
    );
  }
...
const helperContent = `Điều 1.             Mục đích và phạm vi thu thập
...
Dữ liệu của Khách hàng sẽ được lưu trữ cho đến khi có yêu cầu huỷ bỏ hoặc tự Khách hàng đăng nhập và thực hiện huỷ bỏ. Còn lại trong mọi trường hợp thông tin Khách hàng sẽ được bảo mật trên máy chủ của Ban quản trị Website. Địa chỉ của đơn vị thu thập và quản lý thông tin Công ty Công ty Đấu giá Hợp danh Hòa Lạc.

Điều 5.              Những chủ thể có quyền tiếp cận thông tin
1.      Công ty Đấu giá Hợp danh Hòa Lạc, các Đấu giá viên và các thư ký hỗ trợ và thực hiện cuộc đấu giá tài sản. Các Đấu giá viên được phân công phụ trách phiên đấu giá sẽ chỉ có thể thể tiếp cận thông tin cá nhân của những khách hàng tham gia phiên đấu giá đó.
...
Trong trường hợp có yêu cầu của pháp luật: Công ty Đấu giá Hợp danh Hòa Lạc có trách nhiệm hợp tác cung cấp thông tin cá nhân khách hàng khi có yêu cầu từ cơ quan tư pháp bao gồm: Viện kiểm sát, tòa án, cơ quan công an điều tra liên quan đến hành vi vi phạm pháp luật. Ngoài ra, không ai có quyền xâm phạm vào thông tin cá nhân của khách hàng.

Điều 6.             Địa chỉ của đơn vị thu thập và quản lý thông tin
Công ty Đấu giá Hợp danh Hòa Lạc (trụ sở tại Số 49 phố Văn Cao, phường Liễu Giai, quận Ba Đình, thành phố Hà Nội) thu thập và lưu trữ thông tin tại các địa chỉ sau đây:
...
Trường hợp khách hàng có nhu cầu hỏi về hoạt động thu thập, xử lý thông tin liên quan đến cá nhân mình, vui lòng liên hệ qua Email: Daugiafpt@gmail.comtion.vn.
